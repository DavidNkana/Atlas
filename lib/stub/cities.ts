...
export const CITIES: City[] = [
  ...
  { id: "pretoria",      name: "Pretoria",       aliases: ["pretoria", "tshwane", "hatfield", "menlyn", "pretoria east", "pretoria west", "laudium"],         country: "South Africa", lat: -25.7479, lng: 28.2293, countryCode: "ZA", currency: "ZAR" },
