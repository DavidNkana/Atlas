...
> = {
  ...
  cape_town: {
    ...
    gas_station: [
      {
        name: "Durbanville / Wellington Road (Northern Suburbs)",
        suburb: "Durbanville",
        lat: -33.8400,
        lng: 18.6580,
        rationale:
          "Wellington Road / Main Road intersection in Durbanville, Northern Suburbs' main commercial node, 22,000+ vehicles/day. Established middle-to-upper-income catchment with limited modern forecourts within 3km.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 1.3,
        priceRange: "R 2.4M - R 4.8M (Northern Suburbs commercial)",
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "Wellington Road (R311) / Main Road",
        nearestHighwayKm: 4.5,
        competition: ["Sasol Durbanville (1.2km)", "Engen Durbanville (1.8km)", "Shell Welgemoed (3.0km)"],
        medianIncome: 32000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Bellville / Willie van Schoor Avenue forecourt",
        suburb: "Bellville",
        lat: -33.8900,
        lng: 18.6300,
        rationale:
          "Willie van Schoor Avenue (M16) arterial in central Bellville, 30,000+ vehicles/day. Commercial + student catchment from University of the Western Cape and Northlink College nearby. Strong diesel demand from fleet operators.",
        source: "SANRAL + City of Cape Town traffic data",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 2.6M - R 4.5M (Bellville CBD)",
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "Willie van Schoor Avenue (M16)",
        nearestHighwayKm: 2.5,
        competition: ["Shell Bellville (380m)", "BP Parow (1.4km)", "TotalEnergies Bellville (2.0km)", "Engen Goodwood (2.7km)"],
        medianIncome: 28000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "Old Paarl Road (R101)",
        nearestHighwayKm: 0.2,
        competition: ["Shell (264m)", "Sasol Halfway House (1.4km)", "Engen (2.0km)", "BP (2.6km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        nearestHighwayKm: 0,
        competition: ["TotalEnergies Somerset Mall (758m)", "Sasol Somerset West (933m)", "Astron Energy (1.3km)"],
        medianIncome: 32000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 2.1,
        priceRange: "R 3.5M - R 6M",
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "R300 (Kuils River Road)",
        nearestHighwayKm: 0,
        competition: ["Engen (973m)", "TotalEnergies Kuilsrivier (1.9km)", "Shell Garage (2.2km)"],
        medianIncome: 28000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.9,
        priceRange: "R 4.5M - R 9M (premium-position CT South)",
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "M3 (Rhodes Drive)",
        nearestHighwayKm: 0.1,
        competition: ["Shell (507m)", "Engen Settlers Way (1.0km)", "Sasol Observatory (1.3km)"],
        medianIncome: 95000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        priceRange: "R 1.5M - R 3M (developing corridor)",
        zoning: "Service Station (SS) zone — Cape Town zoning scheme",
        titleType: "freehold",
        arterial: "R27 (West Coast Road)",
        nearestHighwayKm: 0,
        competition: ["No direct competitors within 3km — gap in the market"],
        medianIncome: 40000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    restaurant: [
      {
        name: "Bo-Kaap / Chiappini Street bistros",
        suburb: "Bo-Kaap",
        lat: -33.9190,
        lng: 18.4160,
        rationale:
          "Bo-Kaap's Chiappini and Wale Street corridor, the city's most photographed heritage precinct. 1.2M+ annual tourist foot traffic, established tourist-friendly bistro market (Biesmiellah, Bo-Kaap Kombuis, etc.).",
        source: "OpenStreetMap + Cape Town Tourism",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.08,
        priceRange: "R 2M - R 4.5M (Bo-Kaap heritage retail)",
        zoning: "Mixed Use 1 (heritage protection overlay)",
        titleType: "freehold",
        arterial: "Chiappini Street / Wale Street",
        nearestHighwayKm: 2.5,
        competition: ["Bo-Kaap Kombuis (160m)", "Biesmiellah (220m)", "The Bombay Bicycle Club (480m)", "Marriana's (550m)"],
        medianIncome: 28000,
        dataProvenance: "Property24 + OSM + Cape Town Tourism + Stats SA Census 2022",
      },
      {
        name: "De Waterkant / main pedestrian strip",
        suburb: "De Waterkant",
        lat: -33.9105,
        lng: 18.4175,
        rationale:
          "De Waterkant / Dixon Street pedestrian strip bordering Bo-Kaap, Cape Town's pink-and-grey village. Established gay-friendly cafe/bistro market and tourist-oriented dining (Carne SA, The Piano Bar, etc.).",
        source: "OpenStreetMap + Cape Town Tourism",
        cornerStand: false,
        facing: "SE",
        plotSizeHectares: 0.06,
        priceRange: "R 2.5M - R 5M (De Waterkant village)",
        zoning: "Mixed Use 1 (heritage protection overlay)",
        titleType: "freehold",
        arterial: "Dixon Street / Somerset Road",
        nearestHighwayKm: 2.0,
        competition: ["Carne SA (130m)", "The Piano Bar (200m)", "café Barcelona (300m)", "Fritz Sonnenberg (500m)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Cape Town Tourism + Stats SA Census 2022",
      },
      {
        name: "Bree Street / Heritage Square (tourist-friendly)",
        suburb: "Bo-Kaap",
        lat: -33.9205,
        lng: 18.4180,
        rationale:
          "Heritage Square bistro cluster on Bree Street at the Bo-Kaap edge, 60+ restaurants within 1km. 8,000+ weekday foot traffic from CBD offices + weekend tourist trade.",
        source: "OpenStreetMap + Cape Town CBD data",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.05,
        priceRange: "R 2.8M - R 5.5M (Bree / Heritage Square)",
        zoning: "Mixed Use 1 (City Bowl CBD overlay)",
        titleType: "freehold",
        arterial: "Bree Street / Hout Street",
        nearestHighwayKm: 2.2,
        competition: ["Truth Coffee (200m)", "Lyon (240m)", "The Bungalow (340m)", "Dear Me (480m)"],
        medianIncome: 48000,
        dataProvenance: "Property24 + OSM + Cape Town CBD report + Stats SA Census 2022",
      },
      {
        name: "Bo-Kaap / Wale Street corner bistros",
        suburb: "Bo-Kaap",
        lat: -33.9175,
        lng: 18.4145,
        rationale:
          "Wale Street / Pentz Street intersection in the heart of Bo-Kaap, 2 hours of colour-painted houses photos. Strong tourist-focused bistro market, 750+ daily tourist visitors during peak season.",
        source: "OpenStreetMap + Cape Town Tourism",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.04,
        priceRange: "R 1.8M - R 3.5M (Bo-Kaap corner retail)",
        zoning: "Mixed Use 1 (heritage protection overlay)",
        titleType: "freehold",
        arterial: "Wale Street / Pentz Street",
        nearestHighwayKm: 2.5,
        competition: ["Bo-Kaap Kombuis (300m)", "Au ful (450m)", "Zulaikha's (650m)", "Sally's Kitchen (700m)"],
        medianIncome: 25000,
        dataProvenance: "Property24 + OSM + Cape Town Tourism + Stats SA Census 2022",
      },
      {
        name: "Tamboerskloof / Kloof Nek bistro row",
        suburb: "Tamboerskloof",
        lat: -33.9245,
        lng: 18.4085,
        rationale:
          "Kloof Nek Road running through Tamboerskloof below Table Mountain, 20+ bistros and cafes in a 1km strip. Tourist trade from Signal Hill + Table Mountain visitors + CBD office workers.",
        source: "OpenStreetMap + City of Cape Town tourism data",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.1,
        priceRange: "R 2.5M - R 5M (Tamboerskloof / Kloof Nek)",
        zoning: "Mixed Use 1 (City Bowl)",
        titleType: "freehold",
        arterial: "Kloof Nek Road (M6)",
        nearestHighwayKm: 1.5,
        competition: ["Café Paradiso (200m)", "The Press Club (300m)", "Bacini's (550m)", "Masala Dosa (600m)"],
        medianIncome: 46000,
        dataProvenance: "Property24 + OSM + City of Cape Town + Stats SA Census 2022",
      },
      {
    ...
    warehouse: [
      {
        name: "Epping Culemborg cold-storage hub (Atlas)",
        suburb: "Epping",
        lat: -33.9350,
        lng: 18.5600,
        rationale:
          "Culemborg / Atlas area inside Epping precinct, Cape Town's largest cold-storage cluster (Clover, SA Cold Storage). Direct N1 + N2 access, proximity to Cape Town port (18km). Bonded cold-rooms 30,000+ pallet capacity.",
        source: "OpenStreetMap + City of Cape Town industrial data",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 3.5,
        priceRange: "R 18M - R 45M (Epping cold-storage campus)",
        zoning: "Industrial 2 (Cold-storage licensed) — Cape Town zoning",
        titleType: "freehold",
        arterial: "Bofors Circle / Viking Road",
        nearestHighwayKm: 1.5,
        competition: ["Montague Gardens (8km)", "Airport Industria (12km)", "Paarden Eiland (10km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + City of Cape Town industrial audit + Stats SA Census 2022",
      },
      {
        name: "Epping 2 / Oosterzee cold-chain facility",
        suburb: "Epping",
        lat: -33.9380,
        lng: 18.5750,
        rationale:
          "Oosterzee / Epping 2 sub-precinct, 20km from Cape Town port via N2. Established pharmaceutical + food-grade cold-storage cluster with 24/7 operations permitted.",
        source: "OpenStreetMap + City of Cape Town industrial data",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 2.8,
        priceRange: "R 15M - R 38M (Epping Oosterzee cold-storage)",
        zoning: "Industrial 2 (Cold-storage licensed) — Cape Town zoning",
        titleType: "freehold",
        arterial: "Oosterzee Road / Range Road",
        nearestHighwayKm: 2.0,
        competition: ["Culemborg (1.5km)", "Montague Gardens (10km)", "Airport Industria (13km)"],
        medianIncome: 17000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Goodwood industrial cold-storage belt",
        suburb: "Goodwood",
        lat: -33.9010,
        lng: 18.5550,
        rationale:
          "Goodwood / N1-city industrial belt adjacent to Epping. Established light-industrial + cold-storage cluster with direct N1 (Monte Vista) interchange access.",
        source: "OpenStreetMap + City of Cape Town",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 2.2,
        priceRange: "R 12M - R 30M (Goodwood cold-storage)",
        zoning: "Industrial 2 — Cape Town zoning",
        titleType: "freehold",
        arterial: "Voortrekker Road (R102)",
        nearestHighwayKm: 1.5,
        competition: ["Epping (3km)", "Parow (2km)", "Northern Suburbs logistics"],
        medianIncome: 22000,
        dataProvenance: "Property24 + OSM + City of Cape Town + Stats SA Census 2022",
      },
      {
        name: "Parow / Elsies River cold-storage facility",
        suburb: "Parow",
        lat: -33.9100,
        lng: 18.5750,
        rationale:
          "Parow / Elsies River industrial pocket adjacent to Epping 1. Established 24/7 cold-storage + abattoir-adjacent operations. Direct R102 Voortrekker Road freight corridor access.",
        source: "OpenStreetMap + City of Cape Town industrial audit",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 2.5,
        priceRange: "R 14M - R 32M (Parow cold-storage)",
        zoning: "Industrial 2 — Cape Town zoning",
        titleType: "freehold",
        arterial: "Voortrekker Road (R102) / Jan van Riebeeck Road",
        nearestHighwayKm: 2.5,
        competition: ["Epping (4km)", "Goodwood (3km)", "Maitland (8km)"],
        medianIncome: 19000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Ravensmead / Epping cape flats cold-storage site",
        suburb: "Ravensmead",
        lat: -33.9450,
        lng: 18.5700,
        rationale:
          "Ravensmead / northern Epping fringe, lower land cost than core Epping. Direct N7 access for Western Cape frozen-export logistics. 24/7 cold-storage operations permitted.",
        source: "OpenStreetMap + City of Cape Town industrial plan",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 4.0,
        priceRange: "R 10M - R 25M (Ravensmead industrial cold-storage)",
        zoning: "Industrial 2 — Cape Town zoning",
        titleType: "freehold",
        arterial: "N7 (Ravensmead interchange) / Wemmershoek Road",
        nearestHighwayKm: 1.0,
        competition: ["Epping (3km)", "Goodwood (5km)", "Athlone (12km)"],
        medianIncome: 15000,
        dataProvenance: "Property24 + OSM + City of Cape Town + Stats SA Census 2022",
      },
      {
    ...
    retail_shop: [
      {
        name: "Canal Walk Phase 2 expansion (flagship fashion)",
        suburb: "Century City",
        lat: -33.8980,
        lng: 18.5150,
        rationale:
          "Canal Walk's 2024 expansion wing, 12,000m² of new flagship fashion retail space. 1.5M+ monthly visits, established Polo, Lacoste, Burberry, H&M anchor tenants. Premium Tygerberg + Century City catchment.",
        source: "OpenStreetMap + Canal Walk management",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 1.2,
        priceRange: "R 8M - R 22M (flagship fashion store)",
        zoning: "Commercial 1 (Canal Walk Special Zone)",
        titleType: "leasehold",
        arterial: "Century Boulevard",
        nearestHighwayKm: 1.0,
        competition: ["V&A Waterfront (12km)", "Cavendish Square (15km)", "Sable Square (700m)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Canal Walk management + Stats SA Census 2022",
      },
      {
        name: "Century City Sable Square flagship fashion",
        suburb: "Century City",
        lat: -33.8880,
        lng: 18.5170,
        rationale:
          "Sable Square mixed-use node adjacent to Canal Walk, established boutique fashion + lifestyle market. 800k+ visits/month, premium Tygerberg catchment of 250,000+ residents.",
        source: "OpenStreetMap + Century City CID",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.6,
        priceRange: "R 4.5M - R 12M (Sable Square flagship)",
        zoning: "Commercial 1 — Century City CID",
        titleType: "leasehold",
        arterial: "Sable Road / Century Boulevard",
        nearestHighwayKm: 1.0,
        competition: ["Canal Walk (700m)", "Bridgeways (400m)", "Ratanga Park (1.5km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Century City CID + Stats SA Census 2022",
      },
      {
        name: "Century City Bridgeways lifestyle centre",
        suburb: "Century City",
        lat: -33.8900,
        lng: 18.5230,
        rationale:
          "Bridgeways precinct adjacent to Canal Walk, established fashion + dining lifestyle market. 600k+ visits/month, mixed-upper-income Tygerberg + Edgemead / Bothasig catchment.",
        source: "OpenStreetMap + Century City CID",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 0.5,
        priceRange: "R 4.8M - R 11M (Bridgeways fashion)",
        zoning: "Commercial 1 — Century City CID",
        titleType: "leasehold",
        arterial: "Bridgeways / Somerset Crescent",
        nearestHighwayKm: 1.5,
        competition: ["Canal Walk (600m)", "Sable Square (400m)", "Canal Walk Phase 2 (1.3km)"],
        medianIncome: 40000,
        dataProvenance: "Property24 + OSM + Century City CID + Stats SA Census 2022",
      },
      {
        name: "Century City Hotel / Convention retail node",
        suburb: "Century City",
        lat: -33.8920,
        lng: 18.5100,
        rationale:
          "Century City hotel + convention-area mixed retail, 1.2M+ tourists annually from adjacent Cape Town International Convention Centre. Established flagship fashion and luxury-accessories market.",
        source: "OpenStreetMap + CTICC + Century City CID",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 0.4,
        priceRange: "R 3.5M - R 8M (CTICC retail)",
        zoning: "Commercial 1 — Century City CID",
        titleType: "leasehold",
        arterial: "Century Boulevard / Convention Lane",
        nearestHighwayKm: 1.0,
        competition: ["Canal Walk (300m)", "Sable Square (700m)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + CTICC + Stats SA Census 2022",
      },
      {
        name: "Ratanga Park retail redevelopment (Canal Walk fringe)",
        suburb: "Century City",
        lat: -33.9050,
        lng: 18.5180,
        rationale:
          "Ratanga Park site after the 2019 theme park closure is being repositioned as a retail and dining precinct adjacent to Canal Walk. 400k+ visits/month, established premium-tenant pipeline.",
        source: "OpenStreetMap + Century City property reports",
        cornerStand: false,
        facing: "NW",
        plotSizeHectares: 0.7,
        priceRange: "R 4M - R 10M (Ratanga retail redevelopment)",
        zoning: "Commercial 1 — Century City CID",
        titleType: "leasehold",
        arterial: "Ratanga Junction Road / Century Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Canal Walk (1.5km)", "Sable Square (1.2km)", "Century City Bridgeways (1.5km)"],
        medianIncome: 36000,
        dataProvenance: "Property24 + OSM + Century City CID + Stats SA Census 2022",
      },
      {
    ...
    residential_land: [
      {
        name: "Hohenort / Constantia Nek luxury estate",
        suburb: "Constantia",
        lat: -34.0200,
        lng: 18.4350,
        rationale:
          "Hohenort / Constantia Nek prestigious address, gated-estate demand from SA-based international executives. 1-3 ha parcels, established wine-landscape views. R 15M-R 60M premium estate market.",
        source: "Property24 + Cape Town zoning + Stats SA Census 2022",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 2.0,
        priceRange: "R 15M - R 60M (Hohenort / Nek estate)",
        zoning: "Residential 1 (special residential)",
        titleType: "freehold",
        arterial: "Constantia Nek Road",
        nearestHighwayKm: 5.0,
        competition: [
          "Bishops Diocesan College (4.5km)",
          "Constantia Waldorf (1.5km)",
        ],
        medianIncome: 135000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Alphen / Alphen Estate luxury residential",
        suburb: "Constantia",
        lat: -34.0200,
        lng: 18.4450,
        rationale:
          "Alphen Estate / Alphen Drive luxury residential. Established high-end gated estates, 1-2 ha parcels. Historic Dutch-style homesteads, premium R 12M-R 35M market. International buyer demand strong.",
        source: "Property24 + Cape Town zoning + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.5,
        priceRange: "R 12M - R 35M (Alphen estate)",
        zoning: "Residential 1 (heritage protection)",
        titleType: "freehold",
        arterial: "Alphen Drive / Constantia Main Road (M41)",
        nearestHighwayKm: 5.5,
        competition: [
          "Constantia Waldorf (1.8km)",
          "Sweet Valley Primary (1.2km)",
          "Bishops (5km)",
        ],
        medianIncome: 145000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      ...
      {
        name: "Nova Constantia / Belle Constantia prestige belt",
        suburb: "Constantia",
        lat: -34.0300,
        lng: 18.4400,
        rationale:
          "Nova Constantia / Belle Constantia prestige enclave, 1-2 ha parcels adjoining Constantia's wine estates. R 18M-R 50M market, established international banker and ambassador catchment.",
        source: "Property24 + Cape Town zoning + Stats SA Census 2022",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.8,
        priceRange: "R 18M - R 50M (Nova / Belle Constantia)",
        zoning: "Residential 1 (special residential)",
        titleType: "freehold",
        arterial: "Doordrift Road / Belle Constantia Road",
        nearestHighwayKm: 5.0,
        competition: [
          "Constantia Waldorf (1.0km)",
          "Bishops (5.5km)",
          "Rondebosch Boys' High (6km)",
        ],
        medianIncome: 155000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Silverhurst / Constantia Upper luxury estate",
        suburb: "Constantia",
        lat: -34.0300,
        lng: 18.4350,
        rationale:
          "Silverhurst Estate / Constantia Upper top-end luxury cluster. 1-4 ha parcels, established schools cluster nearby. Established premium ambassadorial market. R 20M-R 75M for 2-5 ha estates.",
        source: "Property24 + Cape Town zoning + Stats SA Census 2022",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 3.0,
        priceRange: "R 20M - R 75M (Silverhurst estate)",
        zoning: "Residential 1 (special residential)",
        titleType: "freehold",
        arterial: "Silverhurst Lane / Doordrift Road",
        nearestHighwayKm: 5.2,
        competition: [
          "Bishops Diocesan (5.5km)",
          "Constantia Waldorf (0.8km)",
          "Sweet Valley Primary (1.0km)",
        ],
        medianIncome: 165000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Constantia Heights wine-estate conversions",
        suburb: "Constantia",
        lat: -34.0200,
        lng: 18.4500,
        rationale:
          "Constantia Heights wine-estate conversion corridor along Constantia Main Road. Available 2-5 ha parcels suitable for estate conversions / boutique wine-and-residential estates. R 12M-R 40M.",
        source: "Property24 + Cape Town zoning + Stats SA Census 2022",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 3.5,
        priceRange: "R 12M - R 40M (Constantia Heights wine-estate)",
        zoning: "Agricultural 1 (estate rezoning path exists)",
        titleType: "freehold",
        arterial: "Constantia Main Road (M41)",
        nearestHighwayKm: 4.8,
        competition: [
          "Constantia Waldorf (2.5km)",
          "Sweet Valley Primary (2.0km)",
          "Bishops (6km)",
        ],
        medianIncome: 125000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
  ...
  sandton: {
    ...
    gas_station: [
      {
        name: "Grayston Drive / Sandton Drive petrol station",
        suburb: "Grayston",
        lat: -26.0870,
        lng: 28.0610,
        rationale:
          "Grayston Drive (M63) running through the heart of Sandton, 35,000+ weekday vehicles/day. Premium commuter fuel market, established luxury catchment from Sandown, Morningside, and Hyde Park residents.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.7,
        priceRange: "R 4.5M - R 8M (premium Sandton)",
        zoning: "Service Station (SS) zone — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Grayston Drive (M63) / Sandton Drive",
        nearestHighwayKm: 1.2,
        competition: ["Engen Grayston (450m)", "BP Atholl (1.1km)", "Shell Rivonia (1.5km)", "Astron Energy Sandown (1.8km)"],
        medianIncome: 95000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "William Nicol Drive (Hurlingham) forecourt",
        suburb: "Hurlingham",
        lat: -26.0300,
        lng: 28.0220,
        rationale:
          "William Nicol Drive (R511) arterial, 40,000+ vehicles/day feeding into Sandton CBD from Bryanston and Fourways. Under-supplied catchment of affluent Sandton-southern suburbs.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "SW",
        plotSizeHectares: 1.0,
        priceRange: "R 3.8M - R 6.5M (north Sandton arterial)",
        zoning: "Service Station (SS) zone — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "William Nicol Drive (R511)",
        nearestHighwayKm: 0.5,
        competition: ["Astron Energy Hurlingham (320m)", "Sasol William Nicol (700m)", "BP Bryanston (1.2km)"],
        medianIncome: 88000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Rivonia Road (Morningside / Sandown) fuel node",
        suburb: "Morningside",
        lat: -26.0750,
        lng: 28.0580,
        rationale:
          "Rivonia Road (M9) arterial through Morningside/Sandown, 30,000+ vehicles/day. Captive Sandton CBD office-worker market on weekdays + Sandton City shoppers on weekends.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.9,
        priceRange: "R 5M - R 9M (premium Sandton corner)",
        zoning: "Service Station (SS) zone — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Rivonia Road (M9)",
        nearestHighwayKm: 2.0,
        competition: ["Engen Sandton (500m)", "BP Rivonia (700m)", "Shell Grayston (1.2km)", "TotalEnergies Kramerville (1.6km)"],
        medianIncome: 110000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        zoning: "Residential 3 (gated estate overlay) — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Allandale Road (M39)",
        nearestHighwayKm: 4.5,
        competition: ["Sasol Midrand (809m)", "Engen Waterfall Convenience (984m)", "Sasol Old Pretoria (987m)", "BP (1.0km)", "BP Express Waterfall (1.1km)"],
        medianIncome: 48000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        facing: "S",
        plotSizeHectares: 1.8,
        priceRange: "R 2.5M - R 5M (commercial zoned)",
        zoning: "Commercial 2 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "R511 (Main Road)",
        nearestHighwayKm: 0,
        competition: ["Astron Energy Buccleuch (1.7km)", "Engen Woodmead (1.9km)", "Engen Woodlands (2.1km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        facing: "N",
        plotSizeHectares: 0.8,
        priceRange: "R 6M - R 12M (premium Sandton CBD)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "M1 (Sandown)",
        nearestHighwayKm: 0.1,
        competition: ["Engen Kelvin (633m)", "BP Kramerville (966m)", "Shell Marlboro Drive (1.0km)"],
        medianIncome: 138000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        ...
        facing: "E",
        plotSizeHectares: 1.4,
        priceRange: "R 2.8M - R 5.5M (mixed-use)",
        zoning: "Mixed Use 2 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "R55 (Woodmead Drive)",
        nearestHighwayKm: 0.5,
        competition: ["Engen Woodmead (763m)", "Engen Woodlands (920m)", "Astron Energy Buccleuch (1.4km)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
      ...
      },
{
        ...
        lng: 28.0290,
        rationale:
          "Established equestrian-zoned residential, premium restaurant market (Nikos, Tashas, etc.). Premium pricing power.",
        source: "OpenStreetMap + Sandton CID",
      },
      {
        name: "Parkmore / Sandton Central restaurant row",
        suburb: "Parkmore",
        lat: -26.1080,
        lng: 28.0670,
        rationale:
          "Parkmore main road commercial strip, 4,000+ evening trade from Sandton CBD office workers and Parkmore/Sandown residents. Established premium restaurant market (The Butcher Shop & Grill, Wang Thai, etc.).",
        source: "OpenStreetMap + Sandton CID",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.3,
        priceRange: "R 3M - R 6M (Parkmore premium)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Jan Smuts Avenue (M77) / 11th Street",
        nearestHighwayKm: 1.5,
        competition: ["Wang Thai (340m)", "The Butcher Shop & Grill (600m)", "Tashas Parkmore (780m)", "Belthorn Restaurant (1.1km)"],
        medianIncome: 130000,
        dataProvenance: "Property24 + OSM + Sandton CID + Stats SA Census 2022",
      },
      {
        name: "Sandown / Benmore luxury dining",
        suburb: "Sandown",
        lat: -26.1060,
        lng: 28.0500,
        rationale:
          "Sandown / Benmore mixed-use area adjacent to Sandton City. 6,000+ daytime office workers, established high-end dining market (Signature restaurant, Aarya at Sandton, etc.). Captive hotel + convention market.",
        source: "OpenStreetMap + Sandton CID",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 0.4,
        priceRange: "R 4M - R 8M (Sandown premium)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "West Street / Alice Lane",
        nearestHighwayKm: 1.8,
        competition: ["Signature Restaurant (400m)", "Aarya at Sandton (650m)", "Tristan's Restaurant (1.2km)", "Sandton Sun hotel restaurants (1.4km)"],
        medianIncome: 145000,
        dataProvenance: "Property24 + OSM + Sandton CID + Stats SA Census 2022",
      },
      {
        name: "Hyde Park upscale café + bistro strip",
        suburb: "Hyde Park",
        lat: -26.1310,
        lng: 28.0410,
        rationale:
          "Hyde Park / Jan Smuts Avenue premium retail-and-dining strip, 25,000+ monthly foot traffic to Hyde Park Corner mall. Established affluent catchment (R 80k+/mo median).",
        source: "OpenStreetMap + Hyde Park CID",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.25,
        priceRange: "R 3.5M - R 6.5M (Hyde Park premium)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Jan Smuts Avenue (M77)",
        nearestHighwayKm: 2.8,
        competition: ["The Zone @ Hyde Park (250m)", "Mugg & Bean Hyde Park (400m)", "Capeesh Hyde Park (650m)", "Tashas Hyde Park (800m)"],
        medianIncome: 110000,
        dataProvenance: "Property24 + OSM + Hyde Park CID + Stats SA Census 2022",
      },
    ],
    warehouse: [
      {
    ...
    retail_shop: [
      ...
      {
        name: "Melrose Arch luxury retail precinct",
        suburb: "Melrose",
        lat: -26.1350,
        lng: 28.0570,
        rationale:
          "Melrose Arch mixed-use node, one of Joburg's top luxury retail destinations. 5M+ visits/year, established flagship stores (Burberry, Prada, Gucci). European-piazza-style outdoor mall.",
        source: "OpenStreetMap + Amdec Group (Melrose Arch)",
        cornerStand: true,
        facing: "NE",
        plotSizeHectares: 0.6,
        priceRange: "R 8M - R 22M (Melrose Arch flagship)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "leasehold",
        arterial: "Atholl Oaklands Road / Melrose Boulevard",
        nearestHighwayKm: 3.2,
        competition: ["Hyde Park Corner (1.8km)", "Sandton City (3.5km)", "Rosebank Mall (4.2km)"],
        medianIncome: 130000,
        dataProvenance: "Property24 + OSM + Amdec Group + Stats SA Census 2022",
      },
      {
        name: "Atholl Square luxury retail",
        suburb: "Atholl",
        lat: -26.1180,
        lng: 28.0430,
        rationale:
          "Atholl Square on Katherine Street, established luxury retail + convenience center for Sandton's embassy district. 1.5M+ visits/year, high-net-worth customer base.",
        source: "OpenStreetMap + Sandton CID",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.5,
        priceRange: "R 6M - R 15M (Atholl Square)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "leasehold",
        arterial: "Katherine Street / West Street",
        nearestHighwayKm: 1.5,
        competition: ["Sandton City (1.2km)", "Hyde Park Corner (2.0km)", "Melrose Arch (3.0km)"],
        medianIncome: 145000,
        dataProvenance: "Property24 + OSM + Sandton CID + Stats SA Census 2022",
      },
      {
        name: "Benmore Gardens / Sandton flagship retail",
        suburb: "Benmore",
        lat: -26.1100,
        lng: 28.0500,
        rationale:
          "Benmore Gardens upscale retail and dining center, established luxury anchor store market. Direct connection to Sandton City via pedestrian bridge. Premium catchment from Sandown + Benmore residents.",
        source: "OpenStreetMap + Sandton CID",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.4,
        priceRange: "R 5M - R 12M (Benmore flagship)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "leasehold",
        arterial: "West Street / Alice Lane",
        nearestHighwayKm: 1.8,
        competition: ["Sandton City (300m)", "Nelson Mandela Square (700m)", "Hyde Park Corner (2.5km)"],
        medianIncome: 138000,
        dataProvenance: "Property24 + OSM + Sandton CID + Stats SA Census 2022",
      },
      {
        name: "Parkmore / Rivonia luxury retail node",
        suburb: "Parkmore",
        lat: -26.1050,
        lng: 28.0670,
        rationale:
          "Parkmore upscale retail strip along Jan Smuts Avenue, premium boutique and luxury watch/jewellery cluster. 4M+ visits/year, established Sandton-southern luxury market.",
        source: "OpenStreetMap + Parkmore CID",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.3,
        priceRange: "R 4.5M - R 10M (Parkmore luxury)",
        zoning: "Commercial 1 — Sandton town planning scheme",
        titleType: "freehold",
        arterial: "Jan Smuts Avenue (M77)",
        nearestHighwayKm: 1.2,
        competition: ["Sandton City (2.5km)", "Morningside Shopping Centre (1.4km)", "Melrose Arch (4.0km)"],
        medianIncome: 125000,
        dataProvenance: "Property24 + OSM + Parkmore CID + Stats SA Census 2022",
      },
    ],
    residential_land: [
      {
  ...
  johannesburg: {
    ...
    gas_station: [
      {
        name: "Old Potchefstroom Road / Diepkloof fuel station",
        suburb: "Diepkloof",
        lat: -26.2350,
        lng: 27.8800,
        rationale:
          "Old Potchefstroom Road (M77), Soweto's main east-west arterial, 35,000+ vehicles/day through Diepkloof. Undersupplied catchment of 1.4M Soweto residents, currently limited forecourt capacity.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 1.5,
        priceRange: "R 1.4M - R 3M (developing Soweto corridor)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "Old Potchefstroom Road (M77)",
        nearestHighwayKm: 5.5,
        competition: ["Engen Diepkloof (820m)", "Sasol Old Potchefstroom (1.6km)", "BP Zola (2.1km)"],
        medianIncome: 12000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Klipspruit / Koma Road service station",
        suburb: "Klipspruit",
        lat: -26.2520,
        lng: 27.8650,
        rationale:
          "Corner of Koma Road and Klipspruit Road in the heart of Klipspruit, Soweto South-West. Captive working-class residential catchment, 18,000+ vehicles/day, only one existing forecourt within 5km.",
        source: "OpenStreetMap + City of Joburg data",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.2,
        priceRange: "R 1.2M - R 2.5M (Soweto township market)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "Koma Road / Klipspruit Road",
        nearestHighwayKm: 8.0,
        competition: ["Sasol Klipspruit (650m)", "Engen Protea Glen (1.4km)", "Caltex Zola (2.8km)"],
        medianIncome: 9800,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Meadowlands / Orlando West filling station",
        suburb: "Meadowlands",
        lat: -26.2330,
        lng: 27.8920,
        rationale:
          "Meadowlands / Orlando West taxi-and-minibus corridor, 25,000+ vehicles/day serving Soweto's busiest commercial zone. Strong diesel demand from public transport fleet.",
        source: "OpenStreetMap + Stats SA Census 2022",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 1.3,
        priceRange: "R 1.3M - R 2.8M (Soweto CBD-corridor)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "Molefe Street / Soweto Highway (M70)",
        nearestHighwayKm: 4.5,
        competition: ["Engen Meadowlands (450m)", "BP Orlando (1.2km)", "TotalEnergies Zola (2.5km)"],
        medianIncome: 10500,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
    ...
    restaurant: [
      {
        name: "Maboneng / Fox Street rooftop bars cluster",
        suburb: "Maboneng",
        lat: -26.2030,
        lng: 28.0560,
        rationale:
          "Maboneng's Fox Street corridor, established rooftop-bar market (The Living Room, Rand Club rooftop, The Marabi in Hallmark House). 5,000+ weekend foot traffic from Joburg CBD office workers + creative-class residents.",
        source: "OpenStreetMap + Maboneng CID + Joburg Tourism",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.04,
        priceRange: "R 2.5M - R 5M (Fox St rooftop commercial)",
        zoning: "Mixed Use 1 (City of Johannesburg heritage overlay)",
        titleType: "freehold",
        arterial: "Fox Street / Kruger Street",
        nearestHighwayKm: 3.2,
        competition: ["The Living Room (140m)", "The Marabi (220m)", "Rand Club (380m)", "Hallmark House rooftop (440m)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Maboneng CID + Stats SA Census 2022",
      },
      {
        name: "Albrecht Street / Maboneng East loft rooftops",
        suburb: "Maboneng",
        lat: -26.2020,
        lng: 28.0580,
        rationale:
          "Albrecht Street, the eastern extension of Maboneng art-loft district. Established creative-class restaurant+rooftop market with 3,500+ weekend visitors. Converted-warehouse dining concept dominant.",
        source: "OpenStreetMap + Maboneng CID",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.05,
        priceRange: "R 2M - R 4M (Maboneng loft conversions)",
        zoning: "Mixed Use 1 (heritage overlay)",
        titleType: "freehold",
        arterial: "Albrecht Street / End Street",
        nearestHighwayKm: 3.0,
        competition: ["Arts on Main (120m)", "Venue Indaba (220m)", "Living Room (320m)", "Maboneng cafe (430m)"],
        medianIncome: 32000,
        dataProvenance: "Property24 + OSM + Maboneng CID + Stats SA Census 2022",
      },
      {
        name: "Marshalltown / End Street CBD rooftop cluster",
        suburb: "Marshalltown",
        lat: -26.2050,
        lng: 28.0490,
        rationale:
          "Marshalltown CBD corner / End Street entrance to Maboneng, 12,000+ office workers during the day. Existing rooftop bar / restaurant market (Grind, The Country Club) capturing weekend CBD market.",
        source: "OpenStreetMap + Joburg CBD plan",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.08,
        priceRange: "R 3M - R 6.5M (Marshalltown rooftop commercial)",
        zoning: "Commercial 1 (City of Johannesburg CBD)",
        titleType: "freehold",
        arterial: "End Street / Marshall Street",
        nearestHighwayKm: 2.8,
        competition: ["Grind (200m)", "The Country Club (250m)", "Gilroy Beer Hall (350m)", "Pata Pata (430m)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Joburg CBD data + Stats SA Census 2022",
      },
      {
        name: "Arts on Main / Main Street rooftop market",
        suburb: "Maboneng",
        lat: -26.2090,
        lng: 28.0540,
        rationale:
          "Arts on Main / Main Street corridor in the heart of Maboneng, established art-gallery-meets-restaurant market. 2,000+ Saturday visitors at the Arts on Main market, multiple existing rooftop dining tenants.",
        source: "OpenStreetMap + Arts on Main management",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.06,
        priceRange: "R 2.2M - R 4.5M (Maboneng Arts on Main)",
        zoning: "Mixed Use 1 (heritage)",
        titleType: "freehold",
        arterial: "Main Street / Berea Road",
        nearestHighwayKm: 3.5,
        competition: ["Maboneng restaurant (90m)", "CoffeeBloc (180m)", "The Black (240m)", "The Workshop (380m)"],
        medianIncome: 29000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Jeppestown / Main Street Mall rooftop bar",
        suburb: "Jeppestown",
        lat: -26.2050,
        lng: 28.0630,
        rationale:
          "Jeppestown main street corridor adjacent to Maboneng with established rooftop-bar / late-night market. 3,000+ evening foot traffic, 8,000 monthly visitors. Mixed-use heritage conversions.",
        source: "OpenStreetMap + Maboneng fringe data",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.05,
        priceRange: "R 1.8M - R 3.6M (Jeppestown heritage conversions)",
        zoning: "Mixed Use 1 (heritage overlay)",
        titleType: "freehold",
        arterial: "Jeppe Street / Main Street Mall",
        nearestHighwayKm: 2.5,
        competition: ["The Grand (180m)", "Jozi House (320m)", "Jeppe Street Café (250m)", "Gandhi Square (900m)"],
        medianIncome: 25000,
        dataProvenance: "Property24 + OSM + Maboneng fringe + Stats SA Census 2022",
      },
      {
    ...
    warehouse: [
      {
        name: "City Deep freight terminal (JHB South)",
        suburb: "City Deep",
        lat: -26.2200,
        lng: 28.0320,
        rationale:
          "City Deep container + bulk terminal, 8km south of Joburg CBD. Direct M1 + N1 access, established port-of-Joburg role for containerised freight with rail siding on the Reef railway. 24/7 heavy-truck operations permitted.",
        source: "OpenStreetMap + Transnet + City of Joburg industrial data",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 8.0,
        priceRange: "R 25M - R 80M (large-parcel freight hub)",
        zoning: "Industrial 1 — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "M2 motorway / Heidelberg Road (M31)",
        nearestHighwayKm: 1.5,
        competition: ["Linbro Park (18km)", "Aerotropolis OR Tambo (25km)", "Crown Mines (5km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + Transnet port data + Stats SA Census 2022",
      },
      {
        name: "Booysens / Ophirton industrial estate",
        suburb: "Booysens",
        lat: -26.2400,
        lng: 28.0200,
        rationale:
          "Booysens / Ophirton industrial belt south of Joburg CBD. Established light-industrial + warehouse cluster, 24/7 operations, direct M1 south-bound access via Booysens Road interchange.",
        source: "OpenStreetMap + City of Joburg industrial audit",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 2.5,
        priceRange: "R 6M - R 14M (JHB South industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "Booysens Road / Rifle Range Road",
        nearestHighwayKm: 2.0,
        competition: ["Crown Mines (4km)", "City Deep (3km)", "Aeroton (2km)"],
        medianIncome: 16000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Elandsfontein / Spartan JHB South logistics park",
        suburb: "Elandsfontein",
        lat: -26.1800,
        lng: 28.1900,
        rationale:
          "Elandsfontein / Spartan industrial park east of Joburg on the N3 freight corridor. Established heavy-industrial + logistics, 12km from OR Tambo, 24/7 operations permitted.",
        source: "OpenStreetMap + SANRAL + Ekurhuleni IDP",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 4.5,
        priceRange: "R 15M - R 35M (N3 freight corridor)",
        zoning: "Industrial 1 — Ekurhuleni zoning scheme",
        titleType: "freehold",
        arterial: "N3 / Atlas Road",
        nearestHighwayKm: 0.5,
        competition: ["Isando (4km)", "Linbro Park (6km)", "Jet Park (8km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + SANRAL N3 + Stats SA Census 2022",
      },
      {
        name: "Boksburg / Jet Park JHB South distribution hub",
        suburb: "Boksburg",
        lat: -26.2300,
        lng: 28.2500,
        rationale:
          "Jet Park / Boksburg industrial east of Joburg, established distribution cluster near OR Tambo airport. Bonded warehousing, air-freight forwarders, e-commerce fulfilment, 24/7 operations.",
        source: "OpenStreetMap + ACSA + Ekurhuleni IDP",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 3.0,
        priceRange: "R 10M - R 25M (East Rand logistics)",
        zoning: "Industrial 1 — Ekurhuleni zoning scheme",
        titleType: "freehold",
        arterial: "Jet Park Road / N12",
        nearestHighwayKm: 1.0,
        competition: ["Elandsfontein (5km)", "Isando (8km)", "Aeroot (12km)"],
        medianIncome: 22000,
        dataProvenance: "Property24 + OSM + ACSA + Stats SA Census 2022",
      },
      {
        name: "Alberton south / Germiston west industrial (JHB South)",
        suburb: "Alberton",
        lat: -26.2600,
        lng: 28.0900,
        rationale:
          "Alberton / Germiston-west industrial corridor south-east of Joburg CBD. Direct N12 Alberton-Rand access, established heavy-industrial cluster with rail siding access.",
        source: "OpenStreetMap + Ekurhuleni IDP + Stats SA Census 2022",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 3.2,
        priceRange: "R 8M - R 20M (Alberton south industrial)",
        zoning: "Industrial 1 — Ekurhuleni zoning scheme",
        titleType: "freehold",
        arterial: "N12 / Potgieter Street (M89)",
        nearestHighwayKm: 0.5,
        competition: ["Boksburg (10km)", "Elandsfontein (15km)", "City Deep (10km)"],
        medianIncome: 17000,
        dataProvenance: "Property24 + OSM + SANRAL N12 + Stats SA Census 2022",
      },
      {
  ...
  durban: {
    ...
    gas_station: [
      {
        name: "N3 Cato Ridge / R103 truck stop",
        suburb: "Cato Ridge",
        lat: -29.7300,
        lng: 30.5750,
        rationale:
          "N3 / R103 (Old Main Road) interchange, the primary Durban–PMB corridor junction. 28,000+ heavy-vehicle passes/day, established truck-stop demand with diesel-bowser capacity for long-haul fleets.",
        source: "SANRAL N3 traffic counts + OpenStreetMap",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 2.4,
        priceRange: "R 3.5M - R 7M (truck-stop commercial)",
        zoning: "Service Station (SS) zone — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 / R103 (Old Main Road)",
        nearestHighwayKm: 0,
        competition: ["Sasol Cato Ridge (1.1km)", "Shell Cato Ridge (1.5km)", "Engen Camperdown (12km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + SANRAL N3 traffic + Stats SA Census 2022",
      },
      {
        name: "N3 Camperdown truck stop",
        suburb: "Camperdown",
        lat: -29.7050,
        lng: 30.6200,
        rationale:
          "N3 south-bound carriageway between Cato Ridge and Pietermaritzburg, 32,000+ vehicles/day including 9,000+ trucks. Premium truck-stop position for overnight parking and food outlets.",
        source: "SANRAL + freight corridor data",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 2.0,
        priceRange: "R 3M - R 6.5M (N3 freight corridor)",
        zoning: "Service Station (SS) zone — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 (Camperdown)",
        nearestHighwayKm: 0,
        competition: ["BP Camperdown (2.3km)", "TotalEnergies Cato Ridge (8km)", "Shell Hammarsdale (12km)"],
        medianIncome: 16000,
        dataProvenance: "Property24 + OSM + SANRAL + Stats SA Census 2022",
      },
      {
        name: "N3 Pietermaritzburg truck stop (Chief Albert Luthuli)",
        suburb: "Pietermaritzburg",
        lat: -29.6010,
        lng: 30.3790,
        rationale:
          "N3 / Chief Albert Luthuli Street interchange at Pietermaritzburg, 90km from Durban port. Major freight gateway, 35,000+ vehicles/day including 12,000 heavy trucks. Anchor position for PMB-bound logistics.",
        source: "SANRAL + Msunduzi zoning + OSM",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 2.6,
        priceRange: "R 3.2M - R 6M (N3 freight + PMB CBD)",
        zoning: "Service Station (SS) zone — Msunduzi zoning scheme",
        titleType: "freehold",
        arterial: "N3 / Chief Albert Luthuli Street",
        nearestHighwayKm: 0,
        competition: ["Sasol PMB N3 (700m)", "Engen PMB (1.4km)", "Shell PMB Victoria Rd (1.8km)", "Caltex PMB (2.3km)"],
        medianIncome: 20000,
        dataProvenance: "Property24 + OSM + SANRAL + Stats SA Census 2022",
      },
      {
    ...
    warehouse: [
      {
        name: "Cato Ridge distribution centre precinct",
        suburb: "Cato Ridge",
        lat: -29.7300,
        lng: 30.5800,
        rationale:
          "Cato Ridge logistics hub on the N3 corridor, 65km from Durban port. Established distribution-centre cluster serving inland KZN. Direct N3 access for trucks, large 5-50ha stands available.",
        source: "OpenStreetMap + eThekwini SDF + SANRAL N3 corridor",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 12.0,
        priceRange: "R 18M - R 60M (N3 distribution campus)",
        zoning: "Industrial 2 — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 / R103 (Old Main Road)",
        nearestHighwayKm: 0.5,
        competition: ["Hammarsdale (8km)", "Camperdown (12km)", "PMB North (60km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + eThekwini SDF + SANRAL N3 + Stats SA Census 2022",
      },
      {
        name: "Hammarsdale Cato Ridge industrial / Edwaleni",
        suburb: "Hammarsdale",
        lat: -29.7850,
        lng: 30.6250,
        rationale:
          "Hammarsdale industrial belt adjacent to Cato Ridge, 60km from Durban port. 24/7 heavy-industrial operations, rail siding access, established chemical + manufacturing cluster.",
        source: "OpenStreetMap + eThekwini industrial audit",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 6.0,
        priceRange: "R 12M - R 30M (Hammarsdale industrial)",
        zoning: "Industrial 1 — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 / MR 623 (Hammarsdale Road)",
        nearestHighwayKm: 1.5,
        competition: ["Cato Ridge (8km)", "Pietermaritzburg (25km)", "Camperdown (15km)"],
        medianIncome: 16000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Camperdown distribution park (N3 corridor)",
        suburb: "Camperdown",
        lat: -29.7050,
        lng: 30.6200,
        rationale:
          "Camperdown logistics precinct adjacent to the N3, 35km inland from Durban. Direct N3 access, draft industrial zoning, established inland freight hub for KZN midlands distribution.",
        source: "OpenStreetMap + Msunduzi + eThekwini data",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 8.0,
        priceRange: "R 14M - R 38M (Camperdown N3 distribution)",
        zoning: "Industrial 2 — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 / R103 Camperdown interchange",
        nearestHighwayKm: 0.5,
        competition: ["Cato Ridge (12km)", "Hammarsdale (15km)", "PMB (60km)"],
        medianIncome: 17000,
        dataProvenance: "Property24 + OSM + eThekwini + Stats SA Census 2022",
      },
      {
        name: "Inchanga Cato Ridge industrial extension",
        suburb: "Inchanga",
        lat: -29.7450,
        lng: 30.6600,
        rationale:
          "Inchanga industrial extension east of Cato Ridge, lower land cost than core Cato Ridge. Direct N3 / Inchanga interchange access. Established small-parcel industrial + distribution tenants.",
        source: "OpenStreetMap + eThekwini industrial plan",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 4.5,
        priceRange: "R 8M - R 20M (Inchanga industrial)",
        zoning: "Industrial 1 — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "N3 / Inchanga interchange (P38-1)",
        nearestHighwayKm: 0.2,
        competition: ["Cato Ridge (6km)", "Hammarsdale (12km)", "Camperdown (10km)"],
        medianIncome: 15500,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Gillitts / Hillcrest Cato Ridge corridor",
        suburb: "Gillitts",
        lat: -29.8000,
        lng: 30.7700,
        rationale:
          "Gillitts / Hillcrest extension into the Cato Ridge distribution belt. Established 5-20 hectare distribution parcels, direct M13 / N3 access via Hillcrest interchange.",
        source: "OpenStreetMap + eThekwini SDF",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 10.0,
        priceRange: "R 16M - R 45M (Hillcrest-to-Cato Ridge logistics)",
        zoning: "Industrial 2 — eThekwini zoning scheme",
        titleType: "freehold",
        arterial: "M13 / N3 (Hillcrest interchange)",
        nearestHighwayKm: 1.0,
        competition: ["Hillcrest (5km)", "Kloof (10km)", "Pinetown (15km)"],
        medianIncome: 22000,
        dataProvenance: "Property24 + OSM + eThekwini SDF + Stats SA Census 2022",
      },
      {
    ...
    retail_shop: [
      {
        name: "uMhlanga Village main beachwear cluster",
        suburb: "uMhlanga",
        lat: -29.7280,
        lng: 31.0670,
        rationale:
          "uMhlanga Village, Umhlanga Ridge beachfront precinct. 1.2M+ annual beach-and-holiday tourist visits, established flagship beachwear, swimwear and surf-fashion cluster. Highest foot traffic in uMhlanga outside Gateway.",
        source: "OpenStreetMap + uMhlanga Tourism",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.2,
        priceRange: "R 4M - R 9M (uMhlanga Village beachwear)",
        zoning: "Commercial 1 — eThekwini zoning",
        titleType: "leasehold",
        arterial: "Chartwell Drive / Lagoon Drive",
        nearestHighwayKm: 2.5,
        competition: ["Gateway Theatre (1.5km)", "La Lucia Mall (4km)", "Ballito (45km)"],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + uMhlanga Tourism + Stats SA Census 2022",
      },
      {
        name: "uMhlanga Ridge flagship fashion strip",
        suburb: "uMhlanga Ridge",
        lat: -29.7300,
        lng: 31.0700,
        rationale:
          "uMhlanga Ridge retail/commercial precinct, established flagship fashion + accessories market. 500k+ visits/month, premium Umhlanga-southern catchment (La Lucia, Durban North).",
        source: "OpenStreetMap + uMhlanga Ridge CID",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 0.4,
        priceRange: "R 4.5M - R 10M (uMhlanga Ridge flagship)",
        zoning: "Commercial 1 — eThekwini zoning",
        titleType: "leasehold",
        arterial: "Umhlanga Rocks Drive (M12)",
        nearestHighwayKm: 2.5,
        competition: ["Gateway (1.5km)", "uMhlanga Village (2km)", "La Lucia Mall (3km)"],
        medianIncome: 48000,
        dataProvenance: "Property24 + OSM + uMhlanga CID + Stats SA Census 2022",
      },
      {
        name: "La Lucia Mall flagship fashion",
        suburb: "La Lucia",
        lat: -29.7520,
        lng: 31.0660,
        rationale:
          "La Lucia Mall established 1970s mall with ongoing anchor-store renovation. 1M+ visits/month, premium Durban North catchment of 350,000+ residents.",
        source: "OpenStreetMap + La Lucia Mall management",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 5M - R 12M (La Lucia fashion anchor)",
        zoning: "Commercial 1 — eThekwini zoning",
        titleType: "leasehold",
        arterial: "William Campbell Drive / La Lucia Mall entrance",
        nearestHighwayKm: 2.0,
        competition: ["Gateway (5km)", "uMhlanga Village (4km)", "Musgrave Centre (10km)"],
        medianIncome: 50000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "uMhlanga Lighthouse / Chartwell fashion",
        suburb: "uMhlanga",
        lat: -29.7320,
        lng: 31.0630,
        rationale:
          "Chartwell Drive corridor near uMhlanga Lighthouse, established high-end boutique fashion + footwear market. Strong tourist + resident trade, 5,000+ vehicles/day.",
        source: "OpenStreetMap + uMhlanga Tourism",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.3,
        priceRange: "R 4M - R 9M (Chartwell fashion)",
        zoning: "Commercial 1 — eThekwini zoning",
        titleType: "freehold",
        arterial: "Chartwell Drive",
        nearestHighwayKm: 3.0,
        competition: ["uMhlanga Village (300m)", "Gateway (1.8km)", "uMhlanga Ridge (1.5km)"],
        medianIncome: 65000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Umhlanga Rocks Drive flagship-boutique strip",
        suburb: "uMhlanga",
        lat: -29.7300,
        lng: 31.0750,
        rationale:
          "Umhlanga Rocks Drive (M12) running north, established mid-market fashion + apparel cluster. 25,000 vehicles/day, weekend tourist + resident mixed-trade.",
        source: "OpenStreetMap + eThekwini SDI",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.45,
        priceRange: "R 4.2M - R 9.5M (Umhlanga Rocks Drive)",
        zoning: "Commercial 1 — eThekwini zoning",
        titleType: "freehold",
        arterial: "Umhlanga Rocks Drive (M12)",
        nearestHighwayKm: 2.0,
        competition: ["uMhlanga Ridge (1km)", "Gateway (2km)", "uMhlanga Village (1.8km)"],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + eThekwini + Stats SA Census 2022",
      },
      {
  ...
  pretoria: {
    ...
    restaurant: [
      {
        name: "Hatfield Square / Burnett Street student bars",
        suburb: "Hatfield",
        lat: -25.7490,
        lng: 28.2380,
        rationale:
          "Hatfield Square, 9,500 University of Pretoria students within walking distance. 30+ student-friendly restaurants and pubs, 6,000+ evening foot traffic. Established student bottomless cocktail + brunch market.",
        source: "OpenStreetMap + University of Pretoria precinct",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.05,
        priceRange: "R 1.2M - R 2.5M (student bottomless market)",
        zoning: "Commercial 1 — City of Tshwane zoning",
        titleType: "freehold",
        arterial: "Burnett Street / Church Street (M5)",
        nearestHighwayKm: 5.0,
        competition: ["Café Barcelona Hatfield (60m)", "News Café Hatfield (120m)", "Hinge Café (200m)", "Zest Bistro (340m)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + UP precinct plan + Stats SA Census 2022",
      },
      {
        name: "Jan Shoba Street student café cluster",
        suburb: "Hatfield",
        lat: -25.7510,
        lng: 28.2350,
        rationale:
          "Jan Shoba Street (formerly Devonshire Street), UP Hatfield Campus east gate. 4,000+ student foot traffic during lecture hours + 12 specialist cafés / coffee shops within 300m.",
        source: "OpenStreetMap + UP precinct",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.04,
        priceRange: "R 1.4M - R 2.8M (Jan Shoba student precinct)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Jan Shoba Street",
        nearestHighwayKm: 5.5,
        competition: ["Mugg & Bean UP (80m)", "Jersey Boys coffee (180m)", "Blos Café (260m)", "Pie City Hatfield (340m)"],
        medianIncome: 17000,
        dataProvenance: "Property24 + OSM + UP + Stats SA Census 2022",
      },
      {
        name: "Prospect Street / University of Pretoria restaurant row",
        suburb: "Hatfield",
        lat: -25.7530,
        lng: 28.2400,
        rationale:
          "Prospect Street running adjacent to UP, mixed student and academic restaurant catchment. 25+ restaurants in this 800m strip, established bottomless brunch and sushi delivery market.",
        source: "OpenStreetMap + UP precinct + Tshwane CID",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.08,
        priceRange: "R 1.5M - R 3M (UP Prospect strip)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Prospect Street / Lynwood Road (M8)",
        nearestHighwayKm: 4.0,
        competition: ["Ocean Basket Hatfield (140m)", "News Café Hatfield (300m)", "Bossa Novas Restaurant (450m)"],
        medianIncome: 20000,
        dataProvenance: "Property24 + OSM + UP precinct + Stats SA Census 2022",
      },
      {
        name: "Hilda Street / The Village student-friendly dining",
        suburb: "Hatfield",
        lat: -25.7475,
        lng: 28.2420,
        rationale:
          "Hilda Street / Hatfield Village, dense student-residential precinct next to UP. Strong 7pm-midnight dining trade from student houses. Established casual + Asian restaurant market.",
        source: "OpenStreetMap + Hatfield Village resident association",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 0.06,
        priceRange: "R 1.3M - R 2.6M (Hilda / Village)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Hilda Street / Pretorius Street (M11)",
        nearestHighwayKm: 5.2,
        competition: ["Miyako Sushi (120m)", "Kauai Hatfield (200m)", "The Fussy Vegan (250m)", "RocoMamas Hatfield (380m)"],
        medianIncome: 16500,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Hatfield Plaza / Hatfield Mall fast-casual cluster",
        suburb: "Hatfield",
        lat: -25.7495,
        lng: 28.2370,
        rationale:
          "Hatfield Plaza + Hatfield Mall, 1.2M+ annual student visits. 18 fast-casual and casual-dining tenants (Steers, Nando's, etc.). Established takeaway + dinner trade from UP students.",
        source: "OpenStreetMap + Hatfield Plaza management",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 0.1,
        priceRange: "R 2M - R 4M (Hatfield Mall precinct)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Burnett Street / Hatfield Plaza entrance",
        nearestHighwayKm: 5.0,
        competition: ["Steers Hatfield (50m)", "Nando's Hatfield (80m)", "Wimpy Hatfield (100m)", "Debonairs Hatfield (130m)"],
        medianIncome: 19000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
    ...
    retail_shop: [
      {
        name: "Menlyn Maine Central Square (tech retail)",
        suburb: "Menlyn",
        lat: -25.7830,
        lng: 28.2750,
        rationale:
          "Menlyn Maine Central Square, Pretoria's emerging tech-retail lifestyle centre. 4M+ annual visits, established Apple Store, Samsung, Sony tenants. Strong tech-savvy young-professional catchment.",
        source: "OpenStreetMap + Menlyn Maine management",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.8,
        priceRange: "R 5M - R 12M (Menlyn Maine flagship)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "leasehold",
        arterial: "Atterbury Boulevard / Garstfontein Road",
        nearestHighwayKm: 1.8,
        competition: ["Menlyn Park (700m)", "Woodlands Boulevard (3km)", "Brooklyn Mall (10km)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Menlyn Maine management + Stats SA Census 2022",
      },
      {
        name: "Menlyn Retail Park (tech + lifestyle node)",
        suburb: "Menlyn",
        lat: -25.7860,
        lng: 28.2790,
        rationale:
          "Menlyn Retail Park across from Menlyn Park Shopping Centre, established tech-retail cluster (Incredible Connection, Dion Wired, Hi-Fi Corp). 3.5M+ visits/year, tech-first consumer catchment.",
        source: "OpenStreetMap + Menlyn Park CID",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.5,
        priceRange: "R 4.5M - R 10M (Menlyn Retail Park)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "leasehold",
        arterial: "Atterbury Road / Frikkie de Beer Street",
        nearestHighwayKm: 1.5,
        competition: ["Menlyn Park (300m)", "Menlyn Maine (650m)", "Woodlands Boulevard (3.5km)"],
        medianIncome: 48000,
        dataProvenance: "Property24 + OSM + Menlyn CID + Stats SA Census 2022",
      },
      {
        name: "Atterbury Boulevard tech retail strip",
        suburb: "Menlyn",
        lat: -25.7820,
        lng: 28.2820,
        rationale:
        ...
        facing: "W",
        plotSizeHectares: 0.4,
        priceRange: "R 3.5M - R 7M (Atterbury Boulevard)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Atterbury Road",
        nearestHighwayKm: 1.6,
        competition: ["Menlyn Park (1.5km)", "Menlyn Maine (1.3km)", "Lynnwood Bridge (4km)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + Tshwane CID + Stats SA Census 2022",
      },
      {
        name: "Garsfontein tech retail strip",
        suburb: "Garsfontein",
        lat: -25.7900,
        lng: 28.2900,
        rationale:
          "Garsfontein Road (M30) retail corridor between Menlyn and Woodlands Boulevard. Established middle-class tech-retail market (Hi-tech distributors, IT retail). 30,000+ vehicles/day, family catchment.",
        source: "OpenStreetMap + City of Tshwane data",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.45,
        priceRange: "R 3.5M - R 7M (Garsfontein Road)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "freehold",
        arterial: "Garsfontein Road (M30)",
        nearestHighwayKm: 2.0,
        competition: ["Menlyn Park (3km)", "Woodlands Boulevard (2km)", "Lynnwood Bridge (5km)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Lynnwood Bridge (Pretoria east tech retail)",
        suburb: "Lynnwood",
        lat: -25.7870,
        lng: 28.2750,
        rationale:
          "Lynnwood Bridge mixed-use, 2km west of Menlyn on Lynnwood Road. Established 2M+ visits/year, mixed retail-and-office tech cluster (IT distributors, life-sciences retailers). Premium Lynnwood catchment.",
        source: "OpenStreetMap + Lynnwood Bridge management",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.6,
        priceRange: "R 4.5M - R 9M (Lynnwood Bridge)",
        zoning: "Commercial 1 — Tshwane zoning",
        titleType: "leasehold",
        arterial: "Lynnwood Road (M8)",
        nearestHighwayKm: 2.5,
        competition: ["Menlyn Park (3km)", "Menlyn Maine (3km)", "Brooklyn Mall (5km)"],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
    ...
    residential_land: [
      {
        name: "Faerie Glen security estate corridor",
        suburb: "Faerie Glen",
        lat: -25.7900,
        lng: 28.3050,
        rationale:
          "Faerie Glen / Olympus Drive security estate cluster, established family residential market (1-2 ha parcels). Strong Afrikaans-speaking catchment. R 2M-R 5M entry-level family estates.",
        source: "Property24 + City of Tshwane SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 1.2,
        priceRange: "R 2M - R 5M (Pretoria East family estate)",
        zoning: "Residential 1 (gated estate)",
        titleType: "freehold",
        arterial: "Olympus Drive / Barnard Street",
        nearestHighwayKm: 4.5,
        competition: [
          "Curro Olympus (2.5km)",
          "Laerskool Constantia (3.0km)",
          "Elardus Park (2.1km)",
        ],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      ...
      {
        name: "Wapadrand security village belt",
        suburb: "Wapadrand",
        lat: -25.7950,
        lng: 28.3450,
        rationale:
          "Wapadrand security village corridor, established upper-middle-class residential market. 0.5-1.5 ha parcels, family-school proximity (Curro Waterkloof). R 2.5M-R 6M premium family estates.",
        source: "Property24 + Tshwane SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 2.8M - R 6M (Wapadrand security village)",
        zoning: "Residential 1 (security village)",
        titleType: "freehold",
        arterial: "Wapadrand Road / Olympus Drive",
        nearestHighwayKm: 3.8,
        competition: [
          "Curro Waterkloof (1.8km)",
          "Hoërskool Waterkloof (5km)",
          "Brummeria Primary (4km)",
        ],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Olympus / Equestria lifestyle estate belt",
        suburb: "Olympus",
        lat: -25.8100,
        lng: 28.3450,
        rationale:
          "Olympus / Equestria equestrian lifestyle estate cluster, 1-4 ha parcels. Established equestrian-zoned residential market, R 4M-R 12M premium estates. Strong demand from UP academic and government families.",
        source: "Property24 + Tshwane SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 2.5,
        priceRange: "R 4M - R 12M (Olympus / Equestria lifestyle)",
        zoning: "Residential 1 (equestrian overlay)",
        titleType: "freehold",
        arterial: "Olympus Drive / Equestria Road",
        nearestHighwayKm: 4.0,
        competition: [
          "Hoërskool Waterkloof (5.5km)",
          "Curro Waterkloof (3km)",
          "Brummeria (4km)",
        ],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      ...
      {
        name: "Moreleta Park / Constantia Park family estate",
        suburb: "Moreleta Park",
        lat: -25.8300,
        lng: 28.3100,
        rationale:
          "Moreleta Park / Constantia Park established security-village market, 800m²-2ha family-residential parcels. Established schools (Laerskool Moreleta, Hoërskool Constantia). R 2M-R 4.5M middle-income family estates.",
        source: "Property24 + Tshwane data + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.8,
        priceRange: "R 2.2M - R 4.5M (Moreleta Park family)",
        zoning: "Residential 1",
        titleType: "freehold",
        arterial: "Rubenstein Drive / Garsfontein Road (M30)",
        nearestHighwayKm: 3.5,
        competition: [
          "Laerskool Moreleta (1.4km)",
          "Hoërskool Constantia (2.1km)",
          "Curro Garsfontein (3.5km)",
        ],
        medianIncome: 40000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "The Willows / Willow Acres infill estate",
        suburb: "The Willows",
        lat: -25.7950,
        lng: 28.3300,
        rationale:
          "The Willows / Willow Acres security estate cluster east of Menlyn. Established 1000m²-1.5ha parcels suitable for new-family estate development. R 2.5M-R 5M range.",
        source: "Property24 + Tshwane SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.0,
        priceRange: "R 2.5M - R 5M (Willows / Willow Acres)",
        zoning: "Residential 1 (security estate)",
        titleType: "freehold",
        arterial: "Willow Avenue / Rossouw Avenue",
        nearestHighwayKm: 4.5,
        competition: [
          "Laerskool Willow (1.5km)",
          "Curro Century Crossing (3.2km)",
          "Hoërskool Garsfontein (4km)",
        ],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
  ...
  port_elizabeth: {
    warehouse: [
      {
        name: "Coega IDZ export logistics campus",
        suburb: "Coega",
        lat: -33.7920,
        lng: 25.6780,
        rationale:
          "Coega Industrial Development Zone, 20km east of PE. Designated export-warehouse zone with tax incentives, bonded warehousing, deep-water access via Port of Ngqura (10km). 1,200+ hectare planned industrial footprint.",
        source: "Coega Development Corporation + Transnet + OpenStreetMap",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 25.0,
        priceRange: "R 60M - R 200M (Coega IDZ export campus)",
        zoning: "Industrial 2 (Coega IDZ) — Eastern Cape IDP",
        titleType: "freehold",
        arterial: "N2 (Coega interchange) / Addo Road",
        nearestHighwayKm: 1.0,
        competition: ["Port of Ngqura (10km)", "Markman (25km)", "Neave (15km)"],
        medianIncome: 18000,
        dataProvenance: "Coega Development Corp + Property24 + Stats SA Census 2022",
      },
      {
        name: "Port of Ngqura export warehouse precinct",
        suburb: "Coega",
        lat: -33.8570,
        lng: 25.6820,
        rationale:
          "Port-of-Ngqura-adjacent export warehouse zone, 30km east of PE CBD. Established back-of-port export logistics cluster with direct ship-to-warehouse conveyor systems and customs-bonded operation.",
        source: "Transnet National Ports Authority + OpenStreetMap",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 18.0,
        priceRange: "R 45M - R 150M (port-of-Ngqura export)",
        zoning: "Industrial 2 (Port-adjacent export) — NM Bay IDP",
        titleType: "freehold",
        arterial: "N2 (Ngqura interchange) / Neptune Road",
        nearestHighwayKm: 1.0,
        competition: ["Coega IDZ (6km)", "Deal Party (20km)", "Markman (30km)"],
        medianIncome: 16000,
        dataProvenance: "Transnet NPA + Property24 + Stats SA Census 2022",
      },
      {
        name: "Markman industrial Township export logistics",
        suburb: "Markman",
        lat: -33.8900,
        lng: 25.6400,
        rationale:
          "Markman industrial extension of PE's primary logistics belt, 4km from PE Harbour. Large-parcel industrial stands, freight rail siding, established automotive-supplier cluster.",
        source: "OpenStreetMap + NM Bay Municipality + Transnet",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 6.0,
        priceRange: "R 25M - R 65M (Markman export logistics)",
        zoning: "Industrial 2 — NM Bay zoning",
        titleType: "freehold",
        arterial: "N2 / Markman Road (MR 429)",
        nearestHighwayKm: 0.8,
        competition: ["Deal Party (3km)", "Coega IDZ (28km)", "Neave (8km)"],
        medianIncome: 17000,
        dataProvenance: "Property24 + OSM + Transnet + Stats SA Census 2022",
      },
      {
        name: "Perseverance industrial export warehouse",
        suburb: "Perseverance",
        lat: -33.8800,
        lng: 25.5600,
        rationale:
          "Perseverance industrial belt north of PE CBD, 8km from harbour via N2. Established manufacturing + fabrication tenant base with rail access via the Perseverance rail spur. Lower land cost than port-adjacent zones.",
        source: "OpenStreetMap + NM Bay zoning + Transnet",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 5.5,
        priceRange: "R 20M - R 50M (Perseverance industrial)",
        zoning: "Industrial 1 — NM Bay zoning",
        titleType: "freehold",
        arterial: "N2 (Perseverance interchange) / Old Uitenhage Road",
        nearestHighwayKm: 0.5,
        competition: ["Deal Party (10km)", "Markman (12km)", "Struandale (8km)"],
        medianIncome: 15000,
        dataProvenance: "Property24 + OSM + NM Bay + Stats SA Census 2022",
      },
      {
        name: "Struandale / Burman Road export warehouse park",
        suburb: "Struandale",
        lat: -33.9210,
        lng: 25.6080,
        rationale:
          "Struandale / Burman Road industrial extension, 4km from PE harbour. Light-industrial + export-warehouse mix, established 3PL operators. Good for last-mile + export consolidation.",
        source: "OpenStreetMap + NM Bay data + Transnet",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 3.5,
        priceRange: "R 18M - R 40M (Struandale export)",
        zoning: "Industrial 1 — NM Bay zoning",
        titleType: "freehold",
        arterial: "Burman Road / Kempston Road",
        nearestHighwayKm: 1.5,
        competition: ["Neave (1km)", "Deal Party (3km)", "Markman (6km)"],
        medianIncome: 16000,
        dataProvenance: "Property24 + OSM + NM Bay + Stats SA Census 2022",
      },
      {
  ...
  // ============================================================
  // MIDRAND (new city — added for Prompt 19)
  // ============================================================
  midrand: {
    agricultural_land: [
      {
        name: "Beaulieu smallholdings (peri-urban Midrand)",
        suburb: "Beaulieu",
        lat: -26.0050,
        lng: 28.0800,
        rationale:
          "Beaulieu peri-urban holdings 5km west of Midrand CBD. 1-5 hectare parcels, equestrian and small-farming zoning, established residential-led conversion market. R 800k-R 2M/ha.",
        source: "OpenStreetMap landuse=farmland + City of Johannesburg SDF",
      },
      {
        name: "Kyalami smallholdings (Midrand edge)",
        suburb: "Kyalami",
        lat: -25.9940,
        lng: 28.0710,
        rationale:
          "Established equestrian / smallholding belt north of Midrand, Kyalami-area parcels. 1-4 ha lifestyle-farm land with established Midrand catchment demand.",
        source: "OpenStreetMap + Midrand SDF",
      },
      {
        name: "Crowthorne rural holdings",
        suburb: "Crowthorne",
        lat: -26.0100,
        lng: 28.1800,
        rationale:
          "Crowthorne rural holdings east of Midrand, 5-50 hectare parcels. Equestrian + agritourism operator demand, M39 / Woodmead Drive access.",
        source: "OpenStreetMap + Johannesburg SDF",
      },
      {
        name: "Sunninghill rural holdings",
        suburb: "Sunninghill",
        lat: -26.0050,
        lng: 28.0750,
        rationale:
          "Sunninghill rural holdings, peri-urban Midrand. 1-5 ha parcels, transition zone between Sandton and Midrand. R 1M-R 3M/ha established market.",
        source: "OpenStreetMap + Johannesburg zoning",
      },
      {
        name: "Blue Hills smallholdings (Midrand south-east)",
        suburb: "Blue Hills",
        lat: -25.9800,
        lng: 28.1500,
        rationale:
          "Blue Hills / Midrand south-east peri-urban holdings, 2-20 hectare parcels, established equine and lifestyle-farm demand. 10km from Midrand CBD.",
        source: "OpenStreetMap + Midrand SDF",
      },
    ],
    gas_station: [
      {
        name: "N1 / Allandale Road interchange (Midrand)",
        suburb: "Halfway House",
        lat: -26.0000,
        lng: 28.1300,
        rationale:
          "N1 highway + Allandale Road (M39) interchange in Midrand, 80,000+ vehicles/day. Premium Midrand commuter + freight fuel market, direct Sandton-Pretoria corridor.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 1.2,
        priceRange: "R 3.5M - R 7M (Midrand N1 fuel)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning scheme",
        titleType: "freehold",
        arterial: "N1 / Allandale Road (M39)",
        nearestHighwayKm: 0,
        competition: ["Sasol Midrand (550m)", "Engen Midrand (920m)", "Shell Halfway House (1.1km)"],
        medianIncome: 48000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Waterfall N1 highway interchange",
        suburb: "Waterfall",
        lat: -25.9850,
        lng: 28.1300,
        rationale:
          "N1 highway through Waterfall, 70,000+ vehicles/day including 9,000 trucks. Waterfall logistics precinct feeds commuter + freight fuel market.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.4,
        priceRange: "R 3.5M - R 6.5M (Waterfall N1)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "N1 / Waterfall interchange",
        nearestHighwayKm: 0,
        competition: ["Engen Waterfall Convenience (650m)", "BP Waterfall (900m)", "Sasol Midrand (2.2km)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + SANRAL + Stats SA Census 2022",
      },
      {
        name: "Woodmead Drive / M39 Midrand fuel node",
        suburb: "Vorna Valley",
        lat: -25.9900,
        lng: 28.0900,
        rationale:
          "Woodmead Drive (M39) / Arthur Road intersection in Midrand Vorna Valley. 22,000+ vehicles/day, established family residential + Woodmead office catchment.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 2.8M - R 5.5M (Midrand Woodmead Drive)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Woodmead Drive (M39)",
        nearestHighwayKm: 1.5,
        competition: ["Sasol Vorna Valley (640m)", "Shell Woodmead (1.3km)", "Engen Woodmead (1.7km)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "N1 New Road / Kyalami interchange",
        suburb: "Kyalami",
        lat: -26.0050,
        lng: 28.1150,
        rationale:
          "N1 / New Road (R55) interchange at Kyalami, 60,000+ vehicles/day. Established Midrand northern commuter market with equestrian and country-estate demand.",
        source: "SANRAL + OpenStreetMap",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 1.1,
        priceRange: "R 3.2M - R 6M (Kyalami N1)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "N1 / R55 (Main Road) interchange",
        nearestHighwayKm: 0,
        competition: ["Engen Kyalami (780m)", "BP Kyalami (1.3km)", "Shell Kyalami (2.1km)"],
        medianIncome: 58000,
        dataProvenance: "Property24 + OSM + SANRAL + Stats SA Census 2022",
      },
      {
        name: "Midrand CBD Grand Central forecourt",
        suburb: "Midrand CBD",
        lat: -25.9980,
        lng: 28.1270,
        rationale:
          "Grand Central Boulevard just off the N1 in central Midrand, 25,000+ vehicles/day. Established commuter + Mall-of-Africa-adjacent fuel market.",
        source: "OpenStreetMap + City of Joburg SDF",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.8,
        priceRange: "R 3M - R 5.5M (Midrand CBD)",
        zoning: "Service Station (SS) zone — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Grand Central Boulevard / Church Street",
        nearestHighwayKm: 1.2,
        competition: ["Sasol Midrand (450m)", "Engen Midrand (700m)", "Caltex Midrand (1km)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    restaurant: [
      {
        name: "Mall of Africa / Waterfall dining precinct",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1400,
        rationale:
          "Mall of Africa dining precinct at Waterfall, 7M+ annual visits. 100+ restaurants across casual-dining and fine-dining. Established Midrand-Waterfall mixed income catchment.",
        source: "OpenStreetMap + Mall of Africa management",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.5,
        priceRange: "R 4M - R 9M (Mall of Africa flagship)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "Waterfall Boulevard / Lone Creek Crescent",
        nearestHighwayKm: 1.5,
        competition: ["Waterfall Corner (500m)", "Midrand CBD (3km)", "Woodmead (8km)"],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Midrand CBD / Grand Central restaurant row",
        suburb: "Midrand CBD",
        lat: -25.9980,
        lng: 28.1270,
        rationale:
          "Grand Central Boulevard / Old Pretoria Road restaurant row. 18+ restaurants, established B-grade commuter dining. Train-station-adjacent with 12,000+ peak-hour commuter flow.",
        source: "OpenStreetMap + City of Joburg SDF",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 0.2,
        priceRange: "R 2M - R 4.5M (Midrand CBD restaurant)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Grand Central Boulevard / Old Pretoria Road",
        nearestHighwayKm: 1.0,
        competition: ["Mall of Africa (3km)", "Midrand Hotel restaurants (200m)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Kyalami Corner restaurant precinct",
        suburb: "Kyalami",
        lat: -25.9940,
        lng: 28.0730,
        rationale:
          "Kyalami Corner / Main Road intersection in upper Midrand, 15+ established restaurants. Strong equestrian / country-living catchment, weekend tourist (Kyalami racecourse) trade.",
        source: "OpenStreetMap + Midrand CID",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.3,
        priceRange: "R 3.5M - R 7M (Kyalami)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "R55 (Main Road) / Kyalami Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Sasol Vorna Valley (2km)", "Sunninghill restaurants (3km)"],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Waterfall Corner lifestyle dining",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1370,
        rationale:
          "Waterfall Corner mixed-use lifestyle node adjacent to Mall of Africa. 25+ casual / family restaurants, established upper-Midrand catchment of 35,000+ residents.",
        source: "OpenStreetMap + Waterfall CID",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 0.4,
        priceRange: "R 3.5M - R 8M (Waterfall Corner)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "Waterfall Drive / Curro Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Mall of Africa (500m)", "Waterfall City mixed-use (300m)", "Vorna Valley restaurants (5km)"],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Sunninghill restaurant strip (Midrand edge)",
        suburb: "Sunninghill",
        lat: -26.0050,
        lng: 28.0750,
        rationale:
          "Sunninghill / Rivonia-extension restaurant strip bordering Midrand. 10+ established restaurants, established middle-to-upper-income catchment north Sandton / Midrand edge.",
        source: "OpenStreetMap + Sandton CID",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 0.15,
        priceRange: "R 2.8M - R 5.5M (Sunninghill strip)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Sunninghill Drive / Edison Crescent",
        nearestHighwayKm: 2.0,
        competition: ["Rivonia Road (3km)", "Woodmead (4km)", "Midrand CBD (5km)"],
        medianIncome: 62000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    warehouse: [
      {
        name: "Waterfall logistics campus (Midrand north)",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1400,
        rationale:
          "Waterfall logistics campus, 500+ hectares, established 3PL tenants (Takealot, DHL, DSV). Direct N1 access, 24/7 operations, 12km from OR Tambo.",
        source: "OpenStreetMap + Waterfall CID",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 15.0,
        priceRange: "R 45M - R 180M (Waterfall logistics campus)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Allandale Road (M39) / Waterfall Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Centurion / Samrand (15km)", "Aerotropolis OR Tambo (25km)", "Linbro Park (12km)"],
        medianIncome: 20000,
        dataProvenance: "Property24 + OSM + Waterfall CID + Stats SA Census 2022",
      },
      {
        name: "Halfway House industrial belt (Midrand)",
        suburb: "Halfway House",
        lat: -26.0000,
        lng: 28.1250,
        rationale:
          "Halfway House industrial belt on the N1, established Midrand manufacturing + distribution cluster. Direct N1 access, 24/7 operations, 30km from Johannesburg CBD.",
        source: "OpenStreetMap + City of Joburg industrial audit",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 4.5,
        priceRange: "R 12M - R 28M (Halfway House industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "N1 / Old Pretoria Road",
        nearestHighwayKm: 0.5,
        competition: ["Waterfall logistics (5km)", "Vorna Valley industrial (4km)", "Centurion / Samrand (15km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Vorna Valley industrial extension",
        suburb: "Vorna Valley",
        lat: -25.9950,
        lng: 28.1150,
        rationale:
          "Vorna Valley industrial extension east of Midrand CBD. Established light-industrial + warehouse cluster, direct M39 / Woodmead Drive access, 24/7 operations.",
        source: "OpenStreetMap + Midrand SDF",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 3.0,
        priceRange: "R 9M - R 22M (Vorna Valley industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "M39 (Woodmead Drive) / Vorna Valley Road",
        nearestHighwayKm: 1.5,
        competition: ["Halfway House (3km)", "Woodmead industrial (3km)", "Waterfall (8km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Kyalami industrial / R55 corridor",
        suburb: "Kyalami",
        lat: -25.9850,
        lng: 28.0750,
        rationale:
          "Kyalami industrial / R55 corridor in Midrand's northern sector. Established R 8M-R 18M warehouse market, M39 / R55 freight access.",
        source: "OpenStreetMap + Midrand zoning",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 3.5,
        priceRange: "R 8M - R 18M (Kyalami industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "R55 / Kyalami Boulevard",
        nearestHighwayKm: 1.8,
        competition: ["Vorna Valley (5km)", "Halfway House (8km)", "Waterfall (10km)"],
        medianIncome: 22000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Crowthorne / Carlswald warehouse park",
        suburb: "Crowthorne",
        lat: -26.0100,
        lng: 28.1800,
        rationale:
          "Crowthorne / Carlswald warehouse park east of Midrand on the N1. Direct N1 access, 2-15 hectare distribution stands, established freight tenants.",
        source: "OpenStreetMap + Midrand SDF",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 6.0,
        priceRange: "R 15M - R 35M (Crowthorne / Carlswald)",
        zoning: "Industrial 2 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "N1 (Allandale interchange) / Crowthorne Road",
        nearestHighwayKm: 1.0,
        competition: ["Halfway House (5km)", "Vorna Valley (8km)", "Aerotropolis OR Tambo (18km)"],
        medianIncome: 16000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    retail_shop: [
      {
        name: "Mall of Africa (Waterfall retail anchor)",
        suburb: "Waterfall",
        lat: -25.9900,
        lng: 28.1400,
        rationale:
          "Largest single-phase mall in SA at 130,000m², 7M+ visits/year, 320+ stores. Established Midrand/Waterfall flagship-destination retail market.",
        source: "OpenStreetMap + Mall of Africa / Atterbury Europe",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 13.0,
        priceRange: "R 8M - R 25M (Mall of Africa flagship)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "Waterfall Boulevard / Lone Creek Crescent",
        nearestHighwayKm: 1.5,
        competition: ["Woodlands Boulevard (8km)", "Mall of the South (15km)", "Sandton City (15km)"],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + Mall of Africa + Stats SA Census 2022",
      },
      {
        name: "Midrand City Shopping Centre",
        suburb: "Midrand CBD",
        lat: -25.9980,
        lng: 28.1270,
        rationale:
          "Midrand City / Grand Central Shopping Centre established 1980s mall, 1.5M+ annual visits. Midrand CBD office + Gautrain-commuter catchment.",
        source: "OpenStreetMap + Midrand CID",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.2,
        priceRange: "R 4.5M - R 10M (Midrand City flagship)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "Grand Central Boulevard / 1st Avenue",
        nearestHighwayKm: 1.0,
        competition: ["Mall of Africa (3km)", "Waterfall Corner (3km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Waterfall Corner / Curro retail node",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1370,
        rationale:
          "Waterfall Corner mixed-use retail node adjacent to Mall of Africa, 200k+ visits/month. Established Curro Waterfall + Reddam House catchment.",
        source: "OpenStreetMap + Waterfall CID",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 0.7,
        priceRange: "R 4M - R 9M (Waterfall Corner)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "Curro Boulevard / Waterfall Drive",
        nearestHighwayKm: 1.5,
        competition: ["Mall of Africa (500m)", "Woodlands Boulevard (8km)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Kyalami Corner retail precinct",
        suburb: "Kyalami",
        lat: -25.9940,
        lng: 28.0730,
        rationale:
          "Kyalami Corner / Main Road intersection in upper Midrand, 15+ retail tenants. Established equestrian and country-living catchment. Weekend leisure demand from the equestrian market.",
        source: "OpenStreetMap + Midrand CID",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 0.8,
        priceRange: "R 3.5M - R 7M (Kyalami Corner)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "R55 (Main Road) / Kyalami Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Sunninghill retail (3km)", "Midrand City (8km)"],
        medianIncome: 58000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Carlswald lifestyle retail (Midrand east)",
        suburb: "Carlswald",
        lat: -25.9850,
        lng: 28.0800,
        rationale:
          "Carlswald Lifestyle Shopping Centre, established 2010s retail on the north Sandton border, 1M+ visits/year. Midrand east family + Sandton-southern suburban catchment.",
        source: "OpenStreetMap + Carlswald CID",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 4M - R 9M (Carlswald)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "leasehold",
        arterial: "New Road / Harry Galaun Drive",
        nearestHighwayKm: 1.8,
        competition: ["Midrand City (5km)", "Woodmead (4km)", "Sunninghill (5km)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    residential_land: [
      {
        name: "Waterfall / Midstream new residential development",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1400,
        rationale:
          "Greenfield residential development at Waterfall/Midstream, largest in Gauteng outside Sandton. 100+ unit gated communities, established Curro + Reddam schools, premium R 1.8M+ land values.",
        source: "OpenStreetMap + Waterfall CID + Midrand SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 12.0,
        priceRange: "R 4M - R 18M (Waterfall new-residential parcel)",
        zoning: "Residential 3 (gated estate overlay)",
        titleType: "freehold",
        arterial: "Allandale Road (M39)",
        nearestHighwayKm: 4.5,
      ...
      {
        name: "Sunninghill residential estate belt",
        suburb: "Sunninghill",
        lat: -26.0050,
        lng: 28.0750,
        rationale:
          "Sunninghill established estate market on the Midrand-Sandton border. Vacant 0.5-1.5 ha parcels suitable for family estate developments, established schools, R 2.8M-R 6M market.",
        source: "Property24 + City of Johannesburg SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "NE",
        plotSizeHectares: 0.8,
        priceRange: "R 2.8M - R 6M (Sunninghill estate)",
        zoning: "Residential 1 (gated estate)",
        titleType: "freehold",
        arterial: "Sunninghill Drive / Edison Crescent",
        nearestHighwayKm: 3.0,
        competition: [
          "Curro Sunninghill (2.5km)",
          "St Peter's College (1.5km)",
          "Bryneven Primary (3km)",
        ],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Midstream estate / Midrand east",
        suburb: "Midstream",
        lat: -25.9850,
        lng: 28.1650,
        rationale:
          "Midstream estate / Midrand east, established 2,000-hectare greenfield residential development. 100+ unit estates available, established schools (Midstream College, Curro), R 1.8M-R 5M family estates.",
        source: "Property24 + Midstream Estate + Stats SA Census 2022",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 4.0,
        priceRange: "R 3.5M - R 9M (Midstream estate)",
        zoning: "Residential 3 (gated estate)",
        titleType: "freehold",
        arterial: "Midstream Boulevard / Olifantsfontein Road",
        nearestHighwayKm: 4.0,
        competition: [
          "Midstream College (2km)",
          "Curro Midstream (2.5km)",
          "Reddam House Midstream (3km)",
        ],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Crowthorne residential growth corridor",
        suburb: "Crowthorne",
        lat: -26.0100,
        lng: 28.1800,
        rationale:
          "Crowthorne residential growth corridor east of Midrand, established equestrian-zoned parcels. 1-3 ha lifestyle estates, 30km from OR Tambo airport, R 4M-R 10M market.",
        source: "Property24 + Midrand SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "S",
        plotSizeHectares: 1.5,
        priceRange: "R 4M - R 10M (Crowthorne)",
        zoning: "Residential 2 (equestrian overlay)",
        titleType: "freehold",
        arterial: "Crowthorne Road / N1 (Allandale interchange)",
        nearestHighwayKm: 1.0,
        competition: [
          "Curro Century Crossing (3.5km)",
          "Reddam House Midstream (5km)",
        ],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Vorna Valley infill residential",
        suburb: "Vorna Valley",
        lat: -25.9950,
        lng: 28.1150,
        rationale:
          "Vorna Valley infill residential plots, established suburb 5km from Midrand CBD. 0.4-1 ha parcels suitable for townhouse and cluster development. R 1.6M-R 3.2M middle-income market.",
        source: "Property24 + City of Joburg SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "W",
        plotSizeHectares: 0.5,
        priceRange: "R 1.6M - R 3.2M (Vorna Valley infill)",
        zoning: "Residential 2 (townhouse density)",
        titleType: "freehold",
        arterial: "Vorna Valley Road / M39 (Woodmead Drive)",
        nearestHighwayKm: 1.5,
        competition: [
          "Curro Fourways (10km)",
          "St Peter's College (5km)",
        ],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ...
    commercial_land: [
      {
        name: "Waterfall City business park",
        suburb: "Waterfall",
        lat: -25.9920,
        lng: 28.1400,
        rationale:
          "Waterfall City commercial office park north of Midrand, planned 100,000+ office workers, Gautrain station, fast-developing Sandton-Midrand office market.",
        source: "OpenStreetMap + Waterfall CID + Stats SA Census 2022",
        cornerStand: true,
        facing: "N",
        plotSizeHectares: 4.0,
        priceRange: "R 8M - R 25M (Waterfall business park)",
        zoning: "Commercial 2 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Allandale Road (M39) / Waterfall Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Sandton CBD (15km)", "Rosebank (20km)", "Centurion (15km)"],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + Waterfall CID + Stats SA Census 2022",
      },
      {
        name: "Halfway House commercial precinct",
        suburb: "Halfway House",
        lat: -26.0000,
        lng: 28.1250,
        rationale:
          "Halfway House commercial precinct adjacent to N1, established Midrand office node, 5,000+ office workers, Gautrain station proximity.",
        source: "OpenStreetMap + City of Joburg SDF",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.2,
        priceRange: "R 4M - R 10M (Halfway House commercial)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Old Pretoria Road / N1",
        nearestHighwayKm: 0.5,
        competition: ["Midrand CBD (2km)", "Waterfall business park (5km)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Midrand CBD / Grand Central office node",
        suburb: "Midrand CBD",
        lat: -25.9980,
        lng: 28.1270,
        rationale:
          "Midrand CBD Grand Central office node, established 4,000+ office workers. Direct N1 access, lower land cost than Sandton.",
        source: "OpenStreetMap + Midrand CID + Stats SA Census 2022",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.8,
        priceRange: "R 3M - R 7M (Midrand CBD commercial)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Grand Central Boulevard / Old Pretoria Road",
        nearestHighwayKm: 1.2,
        competition: ["Halfway House (2km)", "Waterfall (5km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Vorna Valley commercial precinct",
        suburb: "Vorna Valley",
        lat: -25.9950,
        lng: 28.1150,
        rationale:
          "Vorna Valley small-office + commercial corridor, established professional services market. 2,000+ office workers, M39 Woodmead Drive frontage.",
        source: "OpenStreetMap + Midrand SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "E",
        plotSizeHectares: 0.6,
        priceRange: "R 2.8M - R 6M (Vorna Valley commercial)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "M39 (Woodmead Drive)",
        nearestHighwayKm: 1.5,
        competition: ["Midrand CBD (4km)", "Halfway House (3km)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Kyalami commercial / Main Road corridor",
        suburb: "Kyalami",
        lat: -25.9940,
        lng: 28.0730,
        rationale:
          "Kyalami commercial / R55 Main Road corridor north of Midrand. Established upper-income commercial catchment, 1,500+ office workers, equestrian-zoned fringe.",
        source: "OpenStreetMap + Midrand CID + Stats SA Census 2022",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 0.5,
        priceRange: "R 3.2M - R 7M (Kyalami commercial)",
        zoning: "Commercial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "R55 (Main Road) / Kyalami Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Woodmead (5km)", "Midrand CBD (8km)"],
        medianIncome: 52000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    industrial_land: [
      {
        name: "Allandale industrial belt (Midrand)",
        suburb: "Allandale",
        lat: -26.0050,
        lng: 28.1300,
        rationale:
          "Allandale industrial belt north of N1 in Midrand, established manufacturing + warehousing. Direct N1 access, 24/7 operations, rail siding potential.",
        source: "OpenStreetMap + City of Joburg industrial audit",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 5.5,
        priceRange: "R 12M - R 30M (Allandale industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Allandale Road (M39)",
        nearestHighwayKm: 0.5,
        competition: ["Waterfall logistics (3km)", "Vorna Valley industrial (5km)", "Linbro Park (8km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Clayville industrial (Midrand south)",
        suburb: "Clayville",
        lat: -25.9500,
        lng: 28.1100,
        rationale:
          "Clayville industrial south of Midrand near Tembisa border, established light-industrial cluster. Lower land cost than Midrand core, 24/7 operations, N1-connection via Olifantsfontein interchange.",
        source: "OpenStreetMap + Ekurhuleni IDP + Stats SA Census 2022",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 3.5,
        priceRange: "R 8M - R 20M (Clayville industrial)",
        zoning: "Industrial 1 — Ekurhuleni zoning",
        titleType: "freehold",
        arterial: "N1 / Olifantsfontein interchange",
        nearestHighwayKm: 0.5,
        competition: ["Halfway House (8km)", "Vorna Valley (10km)", "Aerotropolis (12km)"],
        medianIncome: 15000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Vorna Valley east industrial extension",
        suburb: "Vorna Valley",
        lat: -25.9800,
        lng: 28.1300,
        rationale:
          "Vorna Valley east industrial extension (established light-industrial + warehousing market). Direct M39 Woodmead Drive access. 24/7 operations permitted.",
        source: "OpenStreetMap + Midrand SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 2.8,
        priceRange: "R 7M - R 18M (Vorna Valley east)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "M39 (Woodmead Drive) / Vorna Valley Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Halfway House (5km)", "Waterfall (8km)", "Centurion (12km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Kyalami industrial / R55 freight corridor",
        suburb: "Kyalami",
        lat: -25.9850,
        lng: 28.0750,
        rationale:
          "Kyalami industrial corridor along R55 (Main Road), established Midrand north industrial zone. Lower-cost alternative to Waterfall, direct M39 access, 24/7 operations.",
        source: "OpenStreetMap + City of Joburg industrial audit",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 3.0,
        priceRange: "R 6M - R 15M (Kyalami industrial)",
        zoning: "Industrial 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "R55 (Main Road)",
        nearestHighwayKm: 2.0,
        competition: ["Waterfall (10km)", "Vorna Valley (5km)", "Woodmead (8km)"],
        medianIncome: 22000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Crowthorne / Allandale industrial park",
        suburb: "Crowthorne",
        lat: -26.0100,
        lng: 28.1800,
        rationale:
          "Crowthorne / east-Midrand industrial park adjacent to Allandale interchange. New industrial zoning, 5-50 hectare parcels, direct N1 access, 24/7 operations.",
        source: "OpenStreetMap + Midrand SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 8.0,
        priceRange: "R 15M - R 35M (Crowthorne industrial park)",
        zoning: "Industrial 2 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "N1 (Allandale interchange) / Crowthorne Road",
        nearestHighwayKm: 1.0,
        competition: ["Halfway House (5km)", "Waterfall (10km)", "Aerotropolis (18km)"],
        medianIncome: 18000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
    mixed_use_land: [
      {
        ...
        lng: 28.1400,
        rationale:
          "Waterfall City mixed-use node, established office + retail + residential, Mall of Africa anchor. Planned 100,000+ residents + workers.",
        source: "OpenStreetMap + Waterfall CID + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 5.0,
        priceRange: "R 12M - R 35M (Waterfall mixed-use)",
        zoning: "Mixed Use 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Allandale Road (M39) / Waterfall Boulevard",
        nearestHighwayKm: 1.5,
        competition: ["Sandton CBD (15km)", "Centurion (15km)", "Midrand CBD (5km)"],
        medianIncome: 60000,
        dataProvenance: "Property24 + OSM + Waterfall CID + Stats SA Census 2022",
      },
      {
        name: "Midrand CBD mixed-use corridor",
        suburb: "Midrand CBD",
        lat: -25.9980,
        lng: 28.1270,
        rationale:
          "Midrand CBD mixed-use corridor, established Gautrain + Grand Central + retail + office. Established Gautrain-adjacent residential demand from Johannesburg and Pretoria.",
        source: "OpenStreetMap + City of Joburg CBD plan + Stats SA Census 2022",
        cornerStand: false,
        facing: "S",
        plotSizeHectares: 1.5,
        priceRange: "R 4M - R 10M (Midrand CBD mixed-use)",
        zoning: "Mixed Use 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Grand Central Boulevard / Old Pretoria Road",
        nearestHighwayKm: 1.2,
        competition: ["Waterfall mixed-use (5km)", "Halfway House (2km)"],
        medianIncome: 38000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Halfway House mixed-use precinct",
        suburb: "Halfway House",
        lat: -26.0000,
        lng: 28.1250,
        rationale:
          "Halfway House mixed-use precinct, established Gautrain-adjacent office-residential cluster. N1 access, 24/7 mixed-use permitted.",
        source: "OpenStreetMap + City of Joburg SDF + Stats SA Census 2022",
        cornerStand: true,
        facing: "W",
        plotSizeHectares: 1.0,
        priceRange: "R 4.5M - R 12M (Halfway House mixed-use)",
        zoning: "Mixed Use 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Old Pretoria Road / N1",
        nearestHighwayKm: 0.5,
        competition: ["Midrand CBD (2km)", "Waterfall mixed-use (5km)"],
        medianIncome: 45000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Vorna Valley mixed-use node",
        suburb: "Vorna Valley",
        lat: -25.9950,
        lng: 28.1150,
        rationale:
          "Vorna Valley mixed-use node, established retail + residential + light-office. M39 Woodmead Drive frontage, established Midrand family catchment.",
        source: "OpenStreetMap + Midrand SDF + Stats SA Census 2022",
        cornerStand: false,
        facing: "N",
        plotSizeHectares: 1.2,
        priceRange: "R 3.5M - R 8M (Vorna Valley mixed-use)",
        zoning: "Mixed Use 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "M39 (Woodmead Drive)",
        nearestHighwayKm: 1.5,
        competition: ["Halfway House (3km)", "Midrand CBD (4km)"],
        medianIncome: 42000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
      {
        name: "Sunninghill mixed-use corridor (Midrand edge)",
        suburb: "Sunninghill",
        lat: -26.0050,
        lng: 28.0750,
        rationale:
          "Sunninghill mixed-use corridor on the Midrand-Sandton border, established retail + office + residential market. Established middle-to-upper-income catchment.",
        source: "OpenStreetMap + Sandton CID + Stats SA Census 2022",
        cornerStand: true,
        facing: "E",
        plotSizeHectares: 1.0,
        priceRange: "R 4M - R 9M (Sunninghill mixed-use)",
        zoning: "Mixed Use 1 — City of Johannesburg zoning",
        titleType: "freehold",
        arterial: "Sunninghill Drive / Edison Crescent",
        nearestHighwayKm: 2.0,
        competition: ["Sandton (8km)", "Midrand CBD (5km)", "Woodmead (3km)"],
        medianIncome: 55000,
        dataProvenance: "Property24 + OSM + Stats SA Census 2022",
      },
    ],
